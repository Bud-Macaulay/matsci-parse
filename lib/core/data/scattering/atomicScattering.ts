/**
 * X-ray atomic scattering factor fit coefficients.
 *
 * For each element, four [a, b] pairs for the Waasmaier-Kirfel
 * parameterization used by pymatgen's XRDCalculator:
