 ...
 *
 * Scalar per-isotope/element scattering lengths used by the neutron
 * diffraction calculator (structure factor weights). Units cancel in
 * scaled patterns; pymatgen uses these values directly.
 *
