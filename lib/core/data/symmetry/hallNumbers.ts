/**
 * Maps each International spacegroup number (1-230) to the list of possible
 * Hall numbers for that spacegroup.
 *
 * Source: Seto's Home Page
 * http://pmsl.planet.sci.kobe-u.ac.jp/~seto/?page_id=37&lang=en
 */
export const hallNumbersOfSpacegroup: Record<number, number[]> = {
  1: [1],
  2: [2],
  3: [3, 4, 5],
  4: [6, 7, 8],
